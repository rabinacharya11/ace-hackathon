        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Card(child: SizedBox(height: MediaQuery.of(context).size.height / 3.5, width: double.infinity, child: Image.network(cloth.imageLink!))),
              SizedBox(
                  ...
                  child: Card(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(cloth.title!, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w500)),
                          ...
                          Text(cloth.descrption!, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w400)),
                          Row(
