...
class _AddItemsScreenState extends State<AddItemsScreen> {
  List<String> ngos = ["Any", "Krishna Chaudhary", "John Cena", "Jonney Deep", "Clint Eastwood"];
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: TextFormField(
                                      maxLines: 3,
                                      decoration: const InputDecoration(
                                        label: Text("Add your product description"),
                                        labelStyle: TextStyle(fontSize: 15),
                                        border: OutlineInputBorder(
                                          borderSide: BorderSide(color: Colors.black, width: 5.0),
                                        ),
              ...
              children: [
                SizedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      child: const Text("Sell", style: TextStyle(fontSize: 16))),
                ),
                SizedBox(
                    height: 40,
                    width: 100,
                    child:
                        ElevatedButton(onPressed: () {}, style: ElevatedButton.styleFrom(backgroundColor: Colors.green), child: const Text("Donate")))
              ],
            ),
            const SizedBox(height: 20),
            // Receipt
